"""Train step 2: BLT with RWKV encoder/decoder, transformer patch mixer.

Same training setup as blt_pure_001 but with RWKV blocks in the
byte encoder and decoder, keeping the transformer patch mixer.
Matched params/budget where possible for comparison.
"""
...
from threads.blt.blt_rwkv_enc_dec import BLT_RWKV_EncoderDecoder
...
def main():
    ...
    ap.add_argument('--exp_id', default='blt_rwkv_encdec_001')
