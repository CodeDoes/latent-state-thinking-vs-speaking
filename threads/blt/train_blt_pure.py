"""Train pure BLT on a small TinyStories slice.

Step 1 of the progression: pure transformer-based BLT (not RWKV).
Tests the baseline byte+patch dual-stream architecture with standard attention.

Goal: verify the dual-stream structure works with transformers, establish
a loss baseline before swapping in RWKV blocks.
"""
...
from threads.blt.blt_pure import BLT_Pure
...
def main():
    ...
    ap.add_argument('--exp_id', default='blt_pure_001')
    ...
    if not text_path.exists():
        ...
        print("Creating a small synthetic dataset...")
