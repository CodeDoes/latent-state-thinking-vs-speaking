...
from threads.byte_state_byte.rnn_patch_model import RNXPatchModel, BYTE_STATE_DIM, PATCH_DIM, VOCAB_SIZE
from domains.byte.byte_vocab import encode, PAD_ID
