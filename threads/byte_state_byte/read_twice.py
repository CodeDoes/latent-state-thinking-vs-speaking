...
from threads.unsorted.bottleneck_analysis import HookManager, metric_saturation_ratio
...
def run_experiment(
    ...
    # Write results
    output = Path("threads/memory_growth/experiments/prog_exp_001/read_twice_results.csv")
