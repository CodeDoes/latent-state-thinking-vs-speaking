...
from threads.byte_state_byte.encoder_state_ablation import EncoderVariant, StateBuffer, PatchModel
...
def main():
    ...
    base_dir = Path(f"threads/byte_state_byte/experiments/{args.exp_id}")
