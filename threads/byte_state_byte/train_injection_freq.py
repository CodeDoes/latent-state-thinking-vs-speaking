...
from threads.byte_state_byte.injection_freq_model import InjectionFreqAdaptiveModel, count_params
...
def train(exp_id="inj_freq_front_001", fusion_mode="front", steps=2000, batch_size=8, max_len=128,
          ...
          text_path="threads/g1g_frontend/experiments/byte_ts_001/text.txt",
        ...
        if step % log_every==0 or step==steps-1:
            ...
            if step % (log_every*5)==0:
                with torch.no_grad():
                    ...
                    # decode few bytes
                    from domains.byte.byte_vocab import ID_TO_BYTE
                    def decode_ids(ids):
...
if __name__=="__main__":
    ...
    parser.add_argument("--text_path", type=str, default="threads/g1g_frontend/experiments/byte_ts_001/text.txt")
