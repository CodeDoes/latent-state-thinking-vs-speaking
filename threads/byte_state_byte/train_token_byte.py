...
from threads.byte_state_byte.token_byte_head_model import TokenByteHeadModel
...
def train(exp_id="tok_byte_bytehead_001", vocab_mode="byte", token_vocab_size=1024, bytes_per_token=4,
          ...
          entropy_weight=0.01, log_every=100, text_path="threads/g1g_frontend/experiments/byte_ts_001/text.txt"):
