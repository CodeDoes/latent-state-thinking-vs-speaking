...
COMPAT = [
    ...
    "    print('P100 (sm_60) detected -> installing torch 2.3.1+cu118 (sm_60-compatible; Kaggle-default torch dropped sm_60 support, so every CUDA op fails without this)...')\n",
...
RUN = [
    ...
    "import sys, os\n",
    "cmd = (f\"{sys.executable} train_converged.py --device cpu \"\n",
