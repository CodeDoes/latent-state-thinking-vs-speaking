...
COMPAT = [
    ...
    "    print('P100 (sm_60) detected -> using Kaggle-default torch in the TRAIN subprocess (no downgrade; the notebook process never imports torch, so the triton double-registration error cannot occur).')\n",
    "else:\n",
